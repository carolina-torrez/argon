        ...
        <div class="card-body p-3">
            <div class="row gx-4">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1">
                            {{ $persona->nombres ?? 'nombre' }} {{ $persona->apellidos ?? 'apellidos' }}
                        </h5>
                        <p class="mb-0 font-weight-bold text-sm">
                            Relaciones Públicasss
                        </p>
                    </div>
                </div>
                    ...
                    <form role="form" method="POST" action={{ route('profile.update',$persona->id) }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Guadar</button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="ci" value="{{ old('ci', $persona->ci) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Extensión</label>
                                        <input class="form-control" type="text" name="extension" value="{{ old('extension', $persona->extension) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nombres"  value="{{ old('nombres', $persona->nombres) }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="apellidos" value="{{ old('apellidos', $persona->apellidos) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="genero" value="{{ old('genero', $persona->genero) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="celular" value="{{ old('celular', $persona->celular) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Fecha de Nacimiento</label>
                                        <input class="form-control" type="text" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $persona->fecha_nacimiento) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Estado Civil</label>
                                        <input class="form-control" type="text" name="estado_civil" value="{{ old('estado-civil', $persona->estado_civil) }}">
                                    </div>
                                </div>
                            </div>
