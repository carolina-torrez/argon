            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                {{-- <li class="nav-item d-flex align-items-center">
                    <form role="form" method="post" action="{{ route('logout') }}" id="logout-form">
                        ...
                        <a href="{{ route('logout') }}"
                            ...
                            <img src="./img/team-1.jpg" class="avatar avatar-sm  me-">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold"> {{ $persona->nombres }}</span><br>
                                            <span class="font-weight-bold">ci: {{ $persona->ci }}</span> 
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold">Nuevo albun</span> Por Travis Scott
                                        </h6>
                                        <p class="text-xs text-secondary mb-0">
                                            <i class="fa fa-clock me-1"></i>
                                            1 día
                        ...
                        <li>
                            <a class="justify-content-center ml-2" href="javascript:;">
                            <li class="nav-item d-flex align-items-center">
                                <form role="form" method="post" action="{{ route('logout') }}" id="logout-form">
                                    @csrf
                                    <a href="{{ route('logout') }}"
